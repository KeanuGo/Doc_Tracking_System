...
<title>Document Code Info</title>
...
<script src = "validate.js"></script>
	...
	<body id="background">
		...
		<script type='text/javascript'>	
			...
			background.setAttribute("style", "width:100%");
			cell.innerHTML = "<br><input type='button' id='adddocbutton' name='add_doc_info' value='Add Document Information' onclick='add_doc_info_function()' class='button' style= 'margin-right: 10px'>";
			cell.innerHTML = cell.innerHTML+"<text>  </text><input type='submit' id='submit' name='submit' value='Save' class='button' style='width:150px'>";
			...
			function add_doc_info_function(){
				...
				cell1.innerHTML = "<input type='text' name='attributeNo" + String(row_count) + "' id='attributeNo" + String(row_count) + "' placeholder='Attribute"+ ' ' + String(row_count+1) + "' class='mytext foo' size='100' style='width:80%'>";
				...
				cell3.innerHTML = "<input type='button' name='remove" + String(row_count) + "' id='remove" + String(row_count) + "' value='X' onclick='remove_doc_info(this)' class ='button' style='width:30px'>";
